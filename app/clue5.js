...
// The name property should have a value that is a string, the height property 
// heightInInches should have a value that is a number, the captured property should have a 
// boolean value, and the outfit property should have a value that is an 
// array. Inside the array, include at least 4 string values.

var carmen = {
  name: 'Carmen SanDiego', heightInInches: 67, captured: false, outfit: ['red hat', 'red coat', 'yellow scarf', 'black boots']
